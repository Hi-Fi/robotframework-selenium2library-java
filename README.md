...
your pom.xml:
    ...
    <dependency>
        ...
        <artifactId>robotframework-seleniumlibrary</artifactId>
        <version>4.0.0-alpha-7.1</version>
        <scope>test</scope>
    </dependency>

If you cannot use the robotframework-maven-plugin you can use the
[jar-with-dependencies](https://repo1.maven.org/maven2/com/github/marketsquare/robotframework-seleniumlibrary/4.0.0-alpha-7.1/robotframework-seleniumlibrary-4.0.0-alpha-7.1-jar-with-dependencies.jar),
which contains all required libraries except ios/android ones (Appium and Selendroid). Running of tests with this can be done with command `java -jar robotframework-seleniumlibrary-4.0.0-alpha-7.1-jar-with-dependencies.jar <test location>`.  

* More information about this library can be found in the
  [Keyword Documentation](https://repo1.maven.org/maven2/com/github/marketsquare/robotframework-seleniumlibrary/4.0.0-alpha-7.1/robotframework-seleniumlibrary-4.0.0-alpha-7.1.html).
* For keyword completion in RIDE you can download this
  [Library Specs](https://repo1.maven.org/maven2/com/github/marketsquare/robotframework-seleniumlibrary/4.0.0-alpha-7.1/robotframework-seleniumlibrary-4.0.0-alpha-7.1.xml)
  and place it in your PYTHONPATH.
